        ...
        const items = [
            ...
            },
            {
                ...
                description: "Алина также известная как Аlino4kaPrincess - основная антагонистка каналов Domer Grief и Огород Домера, она является хейтершой Лены и одержимая фанатка Домера которая хочет выйти за него замуж. Сейчас же, с недавнего времени, она живет с Сергеем Камышниковым (Домером) и является его девушкой. Полная история их отношений и развития событий в майнкрафт-сообществе.",
